...
class PdfDataCollector:
    ...
    def convert_pdf_to_images(self, file_path, save_images=False, *, prefix='page', fmt='PNG'):
        ...
        for image in images:
            ...
            # try to use a dictionary to keep page order
    ...
    def process_single_pdf(self, filename):
        self.convert_pdf_to_images(filename, True, fmt='PDF')
        # collect the folder where the images are saved
...
# use multithreading when reading single files