...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.selectFolderButton.setGeometry(QtCore.QRect(440, 540, 93, 28))
        ...
        self.listView.doubleClicked['QModelIndex'].connect(self.selectFolderButton.click) # type: ignore
